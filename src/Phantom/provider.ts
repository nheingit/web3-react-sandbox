...
export class Phantom extends Connector {
  ...
  declare public provider?: PhantomProvider
  ...
  private async isomorphicInitialize(): Promise<void> {
    ...
    return (this.eagerConnection = import('../Phantom/detect').then(async (m) => {
      const provider = await m.default({ mustBePhantom: false, ...this.options })
